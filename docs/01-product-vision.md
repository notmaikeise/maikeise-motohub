...
Concessionárias que atendem clientes pessoa física, empresas e frotistas podem manter informações de veículos, clientes e negociações em planilhas ou sistemas separados. Isso dificulta a consulta do estoque, aumenta o risco de reservas conflitantes e prejudica a rastreabilidade das vendas.

## Visão

O Maikeise MotoHub é uma plataforma digital para gestão e comercialização de motocicletas, destinada inicialmente a uma concessionária que atende clientes pessoa física e jurídica.

O sistema centraliza estoque, clientes, propostas, reservas e vendas. Clientes acompanham suas negociações e funcionários controlam a operação comercial com organização e rastreabilidade.

## Proposta de valor

### Para clientes

- Consultar unidades disponíveis e seus preços anunciados.
- Manter o próprio cadastro.
- Solicitar e acompanhar propostas.
- Reservar unidades específicas a partir de propostas aceitas.
...
O MVP será **single-tenant**, atendendo uma única concessionária com vários clientes e funcionários.
...
- Facilitar a descoberta de unidades disponíveis.
